...
# Note
I have left this project to work on my own [luau](https://github.com/luau-lang/luau) bindings, teal did not fit my needs, and setting up luau bindings was not as hard as a thought.
